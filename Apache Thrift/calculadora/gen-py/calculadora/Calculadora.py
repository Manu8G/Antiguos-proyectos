...
class Iface(object):
    ...
    def logaritmo_neperiano(self, num1):
        """
        Parameters:
         - num1
...
class Client(Iface):
    ...
    def logaritmo_neperiano(self, num1):
        ...
        """
        self.send_logaritmo_neperiano(num1)
        return self.recv_logaritmo_neperiano()

    def send_logaritmo_neperiano(self, num1):
        self._oprot.writeMessageBegin('logaritmo_neperiano', TMessageType.CALL, self._seqid)
        args = logaritmo_neperiano_args()
        args.num1 = num1
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_logaritmo_neperiano(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = logaritmo_neperiano_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "logaritmo_neperiano failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["logaritmo_neperiano"] = Processor.process_logaritmo_neperiano
    ...
    def process_logaritmo_neperiano(self, seqid, iprot, oprot):
        args = logaritmo_neperiano_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = logaritmo_neperiano_result()
        try:
            result.success = self._handler.logaritmo_neperiano(args.num1)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("logaritmo_neperiano", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class logaritmo_neperiano_args(object):
    """
    Attributes:
     - num1
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('logaritmo_neperiano_args')
        if self.num1 is not None:
            oprot.writeFieldBegin('num1', TType.DOUBLE, 1)
            oprot.writeDouble(self.num1)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(logaritmo_neperiano_args)
logaritmo_neperiano_args.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'num1', None, None, ),  # 1
)


class logaritmo_neperiano_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('logaritmo_neperiano_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.DOUBLE, 0)
            oprot.writeDouble(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(logaritmo_neperiano_result)
logaritmo_neperiano_result.thrift_spec = (
    (0, TType.DOUBLE, 'success', None, None, ),  # 0
)
